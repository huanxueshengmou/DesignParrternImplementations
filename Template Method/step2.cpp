...
class Beverage{
  ...
  virtual void addSpecialCondiments(string str){
    print(str,"was sprinkle into the cup. ");
  };
};
...
int main() {
    // 创建 Coffee 对象
    Coffee coffee;
    print("Preparing cocoa-Coffee Recipe:");
    coffee.prepareRecipe("Sugar");
    coffee.addSpecialCondiments("cocoa");
    print();
...
/*output:
 Preparing cocoa-Coffee Recipe:
bubble and gurgle, There was a gentle tap-tap-tap as the coffee grounds settled into the mug. The water poured from the jug into the glass. Sugarwas dropped into the cup. cocoa
was sprinkle into the cup. 
